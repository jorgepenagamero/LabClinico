<form class="form-horizontal" method="POST" action="{{route('hemogramaCrear')}}" autocomplete="off">
    ...
    <div class="row box-body">
        <div class="col-md-12 ">
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input type="text" name="medico" class="form-control" value="{{$hemograma->medico}}" autofocus>
                </div>
            </div>
            <br />
        </div>
    ...
    <div class="box-footer">
        ...
        <button onClick="imprimir('{{ route('analisisImprimir', array('hemograma', $hemograma->id)) }}')" target="_black" class="btn btn-info pull-right imprimir"><i class="fa fa-print"></i></button>
        @endif
    </div>
</form>