...
<datalist id="reaccion">
    <option value="Acida PH5">
    <option value="Acida PH6">
    <option value="Neutra PH7">
    <option value="Alcalina PH8">
    <option value="Alcalina PH9">
</datalist>
...
<datalist id="urobitmogeno">
    ...
    <option value="12 mgl/dl (++++)">
</datalist>

<datalist id="bilirubina">
    <option value="Negativo">
    <option value="Positivo (+)">
    <option value="Positivo (++)">
    <option value="Positivo (+++)">
