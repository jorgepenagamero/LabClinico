<div class="form-group">
    <label for="bacterias" class="col-md-3 control-label">Bacterias</label>
    <div class="col-md-8">
        <input name="bacterias" value="{{$orina->bacterias}}" class="form-control" list="bacterias" />            
    </div>
</div>
<div class="form-group">
...
<div class="form-group">
    <label for="celulas" class="col-md-3 control-label">Celulas</label>
    <div class="col-md-8">
        <input name="celulas" value="{{$orina->celulas}}" class="form-control" list="celulas" />            
    </div>
</div>
