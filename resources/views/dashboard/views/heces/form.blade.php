    ...
    <div class="row box-body">
        <div class="col-md-12 ">
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <input type="text" name="medico" class="form-control" value="{{$heces->medico}}" autofocus>
                </div>
            </div>
        </div>
...
{{--         <div class="col-md-12">
    ...
    <div class="box-footer">
        ...
        @if($heces->imprimir)
        <button onClick="imprimir('{{ route('analisisImprimir', array('heces', $heces->id)) }}')" target="_black" class="btn btn-info pull-right imprimir"><i class="fa fa-print"></i></button>
        @endif
    </div>
</form>